...
export const AI_SCENARIOS: AIScenario[] = [
  {
    ...
    recommendedSwapIds: ['oats_masala', 'egg_noodles_hack', 'makhana_spiced']
  },
  {
    ...
    recommendedSwapIds: ['makhana_spiced', 'roasted_chana', 'dark_choc_walnut']
  },
  {
    ...
    recommendedSwapIds: ['date_ladoo', 'dark_choc_small', 'banana_cocoa']
  },
  {
    id: 'scenario_monsoon',
    ...
    recommendedSwapIds: ['corn_bhel_chaat', 'baked_pakora', 'jaggery_ginger_chai']
  },
  {
    ...
    recommendedSwapIds: ['roasted_chana', 'makhana_spiced', 'sprout_sandwich']
  },
  {
    ...
    recommendedSwapIds: ['paneer_tikka_quick', 'sattu_drink', 'egg_white_bhurji']
  },
  {
    ...
    recommendedSwapIds: ['rice_cake_honey', 'watermelon_mint_juice', 'chia_pudding']
  },
  {
    ...
    recommendedSwapIds: ['nimbu_pani_fizzy', 'chaas_buttermilk', 'kokum_sharbat']
  },
  {
    ...
    recommendedSwapIds: ['yogurt_parfait', 'date_ladoo', 'fruit_chaat_tangy']
  },
  {
    ...
    recommendedSwapIds: ['makhana_spiced', 'roasted_chana', 'murmura_bhel']
  },
  {
    ...
    recommendedSwapIds: ['roti_pizza', 'rajma_burger', 'hummus_veggie']
  },
  {
    ...
    recommendedSwapIds: ['date_ladoo', 'roasted_chana', 'peanut_butter_banana']
  },
  {
    ...
    recommendedSwapIds: ['poha_light', 'sprout_sandwich', 'egg_white_bhurji']
  },
  {
    ...
    recommendedSwapIds: ['homemade_pani_puri', 'dahi_puri_bowl', 'corn_bhel_chaat']
  },
  {
    ...
    recommendedSwapIds: ['ragi_cookies', 'rice_cake_honey', 'makhana_spiced']
  }
];
